...
<div class="d-flex flex-row flex-wrap">
  <?php foreach(AppRepoManager::getRm()->getEquipementRepository()->getAllEquipement() as $equipements): ?>
    ...
    <div>
      <input type="checkbox" name="equipements[]" value="<?= $equipements->id ?>" role="switch">
    </div>
    <img class="icon-equipement" src="/assets/icons/<?= $equipements->image_path ?>" alt="icones<?= $equipements->label ?>" height="87"
    width="100">
